...
const HARDCODED_FLOW_LAYOUT = {
  nodes: [
    {id: 'node-1', text: 'Have you visited us before?'},
    {id: 'node-2', text: 'First time'},
    {id: 'node-3', text: "I've been here a few times"},
    {id: 'node-4', text: 'I\'m a member'},
    {id: 'node-6', text: 'What made you visit us today?'},
    {id: 'node-7', text: 'I\'m interested in self defense and training'},
    {id: 'node-8', text: 'Just for fun'},
    {id: 'node-9', text: 'I\'m a regular shooter but first time at Shoot Smart'},
    {id: 'node-10', text: 'Other'},
    {id: 'node-11', text: 'What is your primary driver for visiting us?'},
    {id: 'node-12', text: 'Regular firearms practice for self defense'},
    {id: 'node-13', text: 'I\'m a recreational and hobby shooter'},
    {id: 'node-14', text: 'Retail and merchandise'},
    {id: 'node-15', text: 'Other'},
    {id: 'node-17', text: 'What was your primary driver for becoming a member?'},
    {id: 'node-18', text: 'I visit the range several times a month.'},
    {id: 'node-19', text: 'I appreciate the customer service I receive.'},
    {id: 'node-20', text: 'I wanted retail and training discounts.'},
    {id: 'node-21', text: 'Other.'},
    {id: 'node-23', text: 'What made you choose Shoot Smart?'},
    {id: 'node-24', text: 'I saw great reviews online.'},
    {id: 'node-25', text: 'I was recommended or brought here by a friend.'},
    {id: 'node-26', text: 'It was closest to where I live.'},
    {id: 'node-27', text: 'I saw us online and liked the services and pricing.'},
    {id: 'node-28', text: 'Other.'},
    {id: 'node-29', text: 'I\'m looking for guided training. '},
    {id: 'node-34', text: 'What would improve your membership experience with us?'},
    {id: 'node-35', text: 'Exclusive events and training.'},
    {id: 'node-36', text: 'Additional discounts and offers.'},
    {id: 'node-37', text: 'I\'m satisfied with what my membership brings me.'},
    {id: 'node-38', text: 'Other.'},
    {id: 'node-39', text: 'What about your membership beenfits you the least?'},
    {id: 'node-40', text: 'Training credits.'},
    {id: 'node-41', text: 'Retail merchandise discounts.'},
    {id: 'node-42', text: 'Free firearm rental.'},
    {id: 'node-43', text: 'Other.'},
    {id: 'node-46', text: 'What is the primary thing that\'s  going to keep you coming back?'},
    {id: 'node-47', text: 'I like the range and what it offers. '},
    {id: 'node-48', text: 'The customer service. '},
    {id: 'node-49', text: 'The retail and merchandise that\'s offered. '},
    {id: 'node-50', text: 'I want to continue receiving guided training. '},
    {id: 'node-51', text: 'I\'m not planning or won\'t be able to come back.'},
    {id: 'node-52', text: 'Other.'},
    {id: 'node-55', text: 'What made you choose Shoot Smart?'},
    {id: 'node-56', text: 'I saw great reviews online.'},
    {id: 'node-57', text: 'I was recommended or brought here by a friend.'},
    {id: 'node-58', text: 'It was closest to where I live.'},
    {id: 'node-59', text: 'I saw us online and liked the services and pricing.'},
    {id: 'node-60', text: 'Other.'},
    {id: 'node-61', text: 'What\'s the primary reason you haven\'t signed-up for a membership with us?'},
    {id: 'node-62', text: 'The prices are too high.'},
    {id: 'node-63', text: 'I don\'t see enough value in the what\'s offered.'},
    {id: 'node-64', text: 'No real reason.'},
    {id: 'node-65', text: 'Other.'},
    {id: 'node-66', text: 'What is the primary thing that\'s  going to keep you coming back?'},
    {id: 'node-67', text: 'The customer service. '},
    {id: 'node-68', text: 'The retail and merchandise that\'s offered. '},
    {id: 'node-69', text: 'I want to continue receiving guided training. '},
    {id: 'node-70', text: 'I\'m not planning or won\'t be able to come back.'},
    {id: 'node-71', text: 'Other.'},
    {id: 'node-72', text: 'Why won\'t you be coming back?'},
    {id: 'node-73', text: 'I don\'t live in the area.'},
    {id: 'node-74', text: 'I had a negative experience.'},
    {id: 'node-75', text: 'I\'m not interested in firearms, it was just a one time visit.'},
    {id: 'node-76', text: 'Other.'},
    {id: 'node-77', text: 'Would you like a member of our team to reach out to you regarding your experience?'},
    {id: 'node-78', text: 'Yes.'},
    {id: 'node-79', text: 'No.'},
    {id: 'node-80', text: 'Would you like a member of our team to reach out to you to answer any questions?'},
    {id: 'node-81', text: 'New question or idea'},
    {id: 'node-82', text: 'New question or idea'}
  ],
  edges: [
    ...
    {from: 'node-17', to: 'node-18'},
    {from: 'node-17', to: 'node-19'},
    {from: 'node-17', to: 'node-20'},
    {from: 'node-17', to: 'node-21'},
    {from: 'node-4', to: 'node-17'},
    {from: 'node-7', to: 'node-23'},
    {from: 'node-8', to: 'node-23'},
    {from: 'node-9', to: 'node-23'},
    {from: 'node-10', to: 'node-23'},
    {from: 'node-23', to: 'node-24'},
    {from: 'node-23', to: 'node-25'},
    {from: 'node-23', to: 'node-26'},
    {from: 'node-23', to: 'node-27'},
    {from: 'node-23', to: 'node-28'},
    {from: 'node-11', to: 'node-29'},
    {from: 'node-18', to: 'node-34'},
    {from: 'node-19', to: 'node-34'},
    {from: 'node-20', to: 'node-34'},
    {from: 'node-21', to: 'node-34'},
    {from: 'node-34', to: 'node-35'},
    {from: 'node-34', to: 'node-36'},
    {from: 'node-34', to: 'node-37'},
    {from: 'node-34', to: 'node-38'},
    {from: 'node-35', to: 'node-39'},
    {from: 'node-36', to: 'node-39'},
    {from: 'node-37', to: 'node-39'},
    {from: 'node-38', to: 'node-39'},
    {from: 'node-39', to: 'node-40'},
    {from: 'node-39', to: 'node-41'},
    {from: 'node-39', to: 'node-42'},
    {from: 'node-39', to: 'node-43'},
    {from: 'node-24', to: 'node-46'},
    {from: 'node-25', to: 'node-46'},
    {from: 'node-26', to: 'node-46'},
    {from: 'node-27', to: 'node-46'},
    {from: 'node-28', to: 'node-46'},
    {from: 'node-46', to: 'node-47'},
    {from: 'node-46', to: 'node-48'},
    {from: 'node-46', to: 'node-49'},
    {from: 'node-46', to: 'node-50'},
    {from: 'node-46', to: 'node-51'},
    {from: 'node-46', to: 'node-52'},
    {from: 'node-12', to: 'node-55'},
    {from: 'node-13', to: 'node-55'},
    {from: 'node-29', to: 'node-55'},
    {from: 'node-14', to: 'node-55'},
    {from: 'node-15', to: 'node-55'},
    {from: 'node-55', to: 'node-60'},
    {from: 'node-55', to: 'node-59'},
    {from: 'node-55', to: 'node-58'},
    {from: 'node-55', to: 'node-57'},
    {from: 'node-55', to: 'node-56'},
    {from: 'node-61', to: 'node-62'},
    {from: 'node-61', to: 'node-63'},
    {from: 'node-61', to: 'node-64'},
    {from: 'node-61', to: 'node-65'},
    {from: 'node-56', to: 'node-66'},
    {from: 'node-57', to: 'node-66'},
    {from: 'node-58', to: 'node-66'},
    {from: 'node-59', to: 'node-66'},
    {from: 'node-66', to: 'node-67'},
    {from: 'node-66', to: 'node-68'},
    {from: 'node-66', to: 'node-69'},
    {from: 'node-66', to: 'node-70'},
    {from: 'node-66', to: 'node-71'},
    {from: 'node-67', to: 'node-61'},
    {from: 'node-68', to: 'node-61'},
    {from: 'node-69', to: 'node-61'},
    {from: 'node-71', to: 'node-61'},
    {from: 'node-51', to: 'node-72'},
    {from: 'node-70', to: 'node-72'},
    {from: 'node-72', to: 'node-76'},
    {from: 'node-72', to: 'node-75'},
    {from: 'node-72', to: 'node-74'},
    {from: 'node-72', to: 'node-73'},
    {from: 'node-74', to: 'node-77'},
    {from: 'node-77', to: 'node-78'},
    {from: 'node-77', to: 'node-79'},
    {from: 'node-47', to: 'node-80'},
    {from: 'node-48', to: 'node-80'},
    {from: 'node-49', to: 'node-80'},
    {from: 'node-50', to: 'node-80'},
    {from: 'node-52', to: 'node-80'},
    {from: 'node-80', to: 'node-81'},
    {from: 'node-80', to: 'node-82'}
  ]
};
